...
Below is an example of how the program could run
```
...
### Objective 3 - Partner Work
For this section you will need to team up with a partner and brainstorm something interesting to do with Twitter.
...
2. Count the number of tweets originating from your zip code that contain the word "prom".
3. Search for tweets:  (a) created in the last week, (b) that contained the term "giraffes", and (c) were sent from a location within a 10 mile radius of East.   The sample code for this can be found in the sampleInvestigate method.
